...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = TCApplication.instance.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = TCApplication.instance.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
