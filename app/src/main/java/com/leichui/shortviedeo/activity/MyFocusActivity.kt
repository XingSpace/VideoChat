...
class MyFocusActivity : BaseActivity() , SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnLoadMoreListener {

    lateinit var adapter : MyFocusAdapter
    var page = 0
    ...
    private fun getData(){
        ApiMapper.getUserFollow(TCUserMgr.getInstance().userToken, page.toString(), object : OkGoStringCallBack<MyFocusBean>(this, MyFocusBean::class.java, false) {
