...
public class TCVideoInfo implements Serializable {
    ...
    public String video_praise = "0";
    public String video_id;
    public String video_desc;
    public String video_address;
    public String video_discuss_count;
    public String video_praise_count;
    public String video_share_count;
    public String video_collect_count;
    public String is_have_good;
    public String is_good_app;
    public String is_show_car;
