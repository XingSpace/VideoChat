...
import com.leichui.shortviedeo.activity.PublishVideoActivity;
...
public class ShortVideoDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dongtai = (TextView) dialog.findViewById(R.id.dongtai);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_record:
                ...
                TCUserMgr.getInstance().setCurrentVideoId("");
            ...
            case R.id.dongtai:
                dismissDialog();
                Intent intent3 = new Intent(getActivity(), PublishActivity.class);
