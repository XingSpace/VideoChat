...
import com.tencent.qcloud.ugckit.module.upload.EventBusBroadBean;
    ...
    private void fetchSignature() {
        ...
        TCUserMgr.getInstance().getVodSig(new TCUserMgr.Callback() {
            ...
            public void onSuccess(@NonNull JSONObject data) {
                try {
                    mCosSignature = data.getString("sign_string");
                    startPublish();
...
//                }
    ...
    private void showCancelPublishDialog() {
        ...
        final AlertDialog alertDialog = builder.setTitle(mContext.getString(R.string.ugckit_cancel_publish_title)).setCancelable(false).setMessage(R.string.ugckit_cancel_publish_msg)
    ...
    private void UploadUGCVideo(final String videoId, final String videoURL, final String coverURL) {
        ...
        //返回主app
        TCUserMgr.getInstance().setCurrentVideoId(videoId);
        TCUserMgr.getInstance().setCurrentVideoPic(coverURL);
        TCUserMgr.getInstance().setCurrentVideoUrl(videoURL);
...
//            Log.e("asd","----coverURL:" + coverURL + "---videoURL:" +videoURL);
...
//                     * ELK上报：发布视频到服务器
//                     */
//                    Log.e("asd","UploadUGCVideo success");
...
//                     * ELK上报：发布视频到服务器
//                     */
//                    Log.e("asd","UploadUGCVideo onFailure");
