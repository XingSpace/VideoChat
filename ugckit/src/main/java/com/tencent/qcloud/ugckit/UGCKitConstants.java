...
public class UGCKitConstants {
    // 业务Server的地址
    public static final String APP_SVR_URL = "http://goldenhaian.com/DouYin/"; //如果您的服务器没有部署https证书，这里需要用http
    public static final String MYAPP_SVR_URL = "http://goldenhaian.com/DouYin/"; //如果您的服务器没有部署https证书，这里需要用http
    // BGM列表地址
    public static final String SVR_BGM_GET_URL = "http://bgm-1252463788.cosgz.myqcloud.com/bgm_list.json";

    // 小视频Bugly
    public static final String BUGLY_APPID = "5a87699dd4";
    /**
     * 常量字符串
     */
